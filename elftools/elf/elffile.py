...
if TYPE_CHECKING:
    from collections.abc import Callable, Container as TContainer, Iterator
...
class ELFFile:
    ...
    """
    def __init__(self, stream: IO[bytes], stream_loader: Callable[[bytes], IO[bytes]] | None = None) -> None:
        self.stream = stream
    ...
    @classmethod
    def load_from_path(cls, path: bytes | str) -> ELFFile:
    ...
    @staticmethod
    def make_relative_loader(base_path: bytes | str) -> Callable[[bytes], IO[bytes]]:
        ...
        def loader(rel_path: bytes) -> IO[bytes]:
    ...
    def _make_symbol_table_section(self, section_header: Container, name: str) -> SymbolTableSection:
    ...
    def _make_symbol_table_index_section(self, section_header: Container, name: str) -> SymbolTableIndexSection:
    ...
    def _make_sunwsyminfo_table_section(self, section_header: Container, name: str) -> SUNWSyminfoTableSection:
    ...
    def _get_section_header_stringtable(self) -> StringTableSection | None:
    ...
    def _read_dwarf_section(self, section: Section, relocate_dwarf_sections: bool) -> DebugSectionDescriptor:
